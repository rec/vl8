...
class TestGrain(unittest.TestCase):
    ...
    def test_simple(self):
        actual = list(GrainSamples(nsamples=7, overlap=0).chunks(self.data()))
        expected = [
    ...
    def test_variation(self):
        grain = GrainSamples(nsamples=7, overlap=0, rand=Rand(args=(-2, 2), seed=0))
    ...
    def test_grain(self):
        actual = to_list(GrainSamples(nsamples=48).chunks(self.data(1024)))
